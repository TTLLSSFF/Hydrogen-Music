...
export const applyCurrentHifiOutputSettings = lazyPlayerExport('applyCurrentHifiOutputSettings');
export const prepareResolvedPlaybackSongSwitch = lazyPlayerExport('prepareResolvedPlaybackSongSwitch');
...
export const fetchHeartModeRecommendations = lazyPlayerExport('fetchHeartModeRecommendations');
...
export const enforceLocalOnlyPlayback = lazyPlayerExport('enforceLocalOnlyPlayback');
export const restoreOnlinePlayback = lazyPlayerExport('restoreOnlinePlayback');
