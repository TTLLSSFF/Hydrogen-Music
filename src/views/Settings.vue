...
const applySettingsToForm = settings => {
    ...
    downloadCreateSongFolder.value = normalizedSettings.local.downloadCreateSongFolder === true
    downloadSaveLyricFile.value = normalizedSettings.local.downloadSaveLyricFile === true
